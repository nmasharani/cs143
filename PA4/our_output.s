...
str_const0:
	...
	.word	String_dispTab
	.word	int_const9
	.ascii	"valid_testfiles_pa3/tester.cl"
	.byte	0	
	.align	2
	.word	-1
int_const9:
...
heap_start:
	...
	.globl	Bool_init
	.globl	Main.main
# Begin Emmitting code to generate initializer method for Test
Test_init:
	sw	$fp 0($sp)
	addiu	$sp $sp -4
	sw	$s0 0($sp)
	...
	addiu	$sp $sp 12
	jr	$ra	
# End Emmitting code to generate initializer method for Test
...
# Begin Code string const expression at line number 38
	la	$a0 str_const2
# End Code string const expression.
	sw	$a0 28($s0)
# End Code assign expression.
# Begin Code assign expression at line number 39
# Begin Code new with type at line number 39
	la	$a0 IO_protObj
	jal	Object.copy
	jal	IO_init
...
# Begin Emitting code for method get_string
A.get_string:
	sw	$fp 0($sp)
	addiu	$sp $sp -4
	sw	$s0 0($sp)
...
# End Code string const expression.
	...
	addiu	$sp $sp 12
	jr	$ra	
# End Emitting code for method get_string
...
# Begin Code assign expression at line number 5
# Begin Code new with type at line number 5
	la	$a0 Test_protObj
	jal	Object.copy
	jal	Test_init
# End Code new with type Test
	sw	$a0 12($s0)
# End Code assign expression.
