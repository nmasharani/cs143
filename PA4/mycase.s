...
# Begin Emitting code for method alpha
	.globl	Bravo.alpha
Bravo.alpha:
	sw	$fp 0($sp)
	sw	$s0 -4($sp)
...
# End Code new with type Alpha
	...
	addiu	$sp $sp 0
	jr	$ra	
# End Emitting code for method alpha
...
# Begin Code typecase expression at line number 18
# Begin Code disptach expression at line number 18
# Begin Code new with type at line number 18
	la	$a0 Bravo_protObj
	jal	Object.copy
	jal	Bravo_init
...
label11:
# End Code typecase expression.
# Begin Code typecase expression at line number 29
