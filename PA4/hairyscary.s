...
Main_init:
	...
	move	$s0 $a0
	jal	Object_init
# Begin Code new with type at line number 63
	la	$a0 Bazz_protObj
	jal	Object.copy
	jal	Bazz_init
# End Code new with type Bazz
	sw	$a0 12($s0)
# Begin Code new with type at line number 64
	la	$a0 Foo_protObj
	jal	Object.copy
	jal	Foo_init
# End Code new with type Foo
	sw	$a0 16($s0)
# Begin Code new with type at line number 65
	la	$a0 Razz_protObj
	jal	Object.copy
	jal	Razz_init
# End Code new with type Razz
	sw	$a0 20($s0)
# Begin Code new with type at line number 66
	la	$a0 Bar_protObj
	jal	Object.copy
	jal	Bar_init
...
# End Code int const expression.
	sw	$a0 12($s0)
# Begin Code typecase expression at line number 45
...
label3:
	...
	bgt	$t2 5 label4
	sw	$t1 -4($fp)
# Begin Code new with type at line number 48
	la	$a0 Razz_protObj
	jal	Object.copy
	jal	Razz_init
# End Code new with type Razz
...
# End Code typecase expression.
	sw	$a0 16($s0)
# Begin Code static dispatch expression at line number 52
...
Razz_init:
	...
	move	$s0 $a0
	jal	Foo_init
# Begin Code typecase expression at line number 30
...
label9:
	...
	bgt	$t2 5 label10
	sw	$t1 -4($fp)
# Begin Code new with type at line number 31
	la	$a0 Bar_protObj
	jal	Object.copy
	jal	Bar_init
# End Code new with type Bar
...
# End Code typecase expression.
	sw	$a0 32($s0)
# Begin Code plus expression at line number 35
# Begin Code plus expression at line number 35
# Begin Code plus expression at line number 35
# Begin Code plus expression at line number 35
# Begin Code static dispatch expression at line number 35
...
# End Code disptach expression.
	sw	$a0 40($s0)
# Begin Code static dispatch expression at line number 22
...
# End Code plus expression.
	sw	$a0 -4($fp)
# Begin Code static dispatch expression at line number 10
# Begin Code objectID expression at line number 10
	move	$a0 $s0
	bne	$a0 $zero label26
	la	$a0 str_const0
...
Bazz.printh:
	...
	addiu	$sp $sp -4
	move	$s0 $a0
# Begin Code block epression at line number 54
...
Bazz.doh:
	...
	addiu	$sp $sp -8
	move	$s0 $a0
# Begin Code let expression at line number 58
# Begin Code objectID expression at line number 58
# Loading attribute object into ACC
	lw	$a0 12($s0)
# End Code objectID expression.
	sw	$a0 -4($fp)
# Begin Code block epression at line number 58
# Begin Code assign expression at line number 58
# Begin Code plus expression at line number 58
# Begin Code objectID expression at line number 58
# Loading attribute object into ACC
	lw	$a0 12($s0)
# End Code objectID expression.
